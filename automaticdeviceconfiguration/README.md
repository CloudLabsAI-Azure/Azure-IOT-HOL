...
1. Enter a **Device ID** and click **Save**.
...
1. List of devices you added to IoT Hub are listed below

   ![Device List](images/devicelist.png)

## Add Tags to Devices

1. Click on each of **Shinagawa** HVAC devices, under the **Shinagawa** device page click on **Device Twin** icon on the top and add the following to device twin metadata
...
1. Click on each of **Tokyo** HVAC devices, click on **Device Twin**  and add the following to device twin metadata
...
1. In the *IoT devices* page click on **Switch to query editor**.

   ![Query Editor](images/queryeditor.png)

1. Now click on **Enable query editor** and in the pop-up message click on **yes**.

   ![Enable Editor](images/enableeditor.png)

1. Copy the below mentioned query and query for **Shinagawa** devices. You can see the only the **Shinagawa** HVAC devices.
...
1. In IoT Hub page page, under *Automatic Device Management* click on **IoT device configuration**. From IoT Device Configuration select **+ Add Device Configuration**.
...
1. Add labels to help track your configurations. Labels are Name, Value pairs that describe your configuration. For example, ```Version, 1.0.0.```

1. Select **Next: Twin Settings** to move to step two.
...
1. The second is the JSON content to be inserted in that section.

1. Select **Next: Metrics** to move to step three.
...
1. Enter a query for Metric Criteria. The query is based on device twin reported properties. The metric represents the number of rows returned by the query. You can copy the queries from below.

1. Select **Next: Target Devices** to move to step four.
...
1. Enter a Target condition to determine which devices will be targeted with this configuration. The condition is based on device twin tags or device twin reported properties. You can click on **View Devices** to view the Target Devices

1. Select **Next: Review + create** to move on to the final step.
...
1. Now you can view the Results of applied changes.

   ![Create App](images/result.png)

1. Check device twin to see the configuration updates. Go to **IoT Devices**, click on **shinagawahvac1** and click on **device twin**. Similarly check all devices located in **Shinagawa**
